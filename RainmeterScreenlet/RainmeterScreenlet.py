...
class StringMeter (Meter):
  ...
  def paint(self, ctx, screenlet):
    ...
    screenlet.draw_text(ctx, text_to_paint, int(x_pos), int(self._y), self._font_face, int(self._font_size), int(min(screenlet.width, txt_width)), align)
...
class RainmeterScreenlet (Screenlet):
...
#  _new_update_interval = None # used to change the default _update_interval
  ...
  def __init__ (self, **keyword_args):
    """Create a new RainmeterScreenlet instance."""
