...
void test_division2_helper2(char* a_str, char* b_str) {
  ...
  ret1 = bigint_mod_by_int(&a, b_int, &r);
  bigint_copy(&q, &a);
  ret2 = bigint_div_by_int(&q, b_int);
  printf("\nq=");
  print_bigint(&q);
  printf(", r=%d\n", r);
  bigint_init(&r_bi);
  bigint_from_int(&r_bi, r);
  assert(ret1 == -BIGINT_NOERR && ret2 == -BIGINT_NOERR ? divmod_check(&a, &b, &q, &r_bi) == 1 : 1);
  bigint_release(&a);
  bigint_release(&b);
  bigint_release(&q);
  bigint_release(&r_bi);
...
void test_division2() {
  ...
  test_division2_helper2("-988", "989");
  test_division2_helper2("-988", "-989");
  test_division2_helper2("2000", "1000");
  test_division2_helper2("2000", "-1000");
  test_division2_helper2("-2000", "1000");
  test_division2_helper2("-2000", "-1000");
  test_division2_helper2("2000", "1001");
  test_division2_helper2("2000", "-1001");
  test_division2_helper2("-2000", "1001");
  test_division2_helper2("-2000", "-1001");
  test_division2_helper2("2000", "999");
  test_division2_helper2("2000", "-999");
  test_division2_helper2("-2000", "999");
  test_division2_helper2("-2000", "-999");
  test_division2_helper2("2001", "1000");
  test_division2_helper2("2001", "-1000");
  test_division2_helper2("-2001", "1000");
  test_division2_helper2("-2001", "-1000");
  test_division2_helper2("1999", "1000");
  test_division2_helper2("1999", "-1000");
  test_division2_helper2("-1999", "1000");
  test_division2_helper2("-1999", "-1000");
  test_division2_helper("2000000000000000000000", "100000000000000000000000000000000000");
  test_division2_helper("-2000000000000000000000", "100000000000000000000000000000000000");
  test_division2_helper("2000000000000000000000000000000000000000", "100000000000000000000000000000000000");
  test_division2_helper("2000000000000000000000000000000000000000", "10000000000000000000000000000000000000000000");
  test_division2_helper("2000000000000000000000000000000000000000", "100000000000000000000000000000000000");
