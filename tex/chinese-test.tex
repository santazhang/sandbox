% use "xelatex" to compile this tex file under MacOS.
...
\newcommand\SimSun{\fontspec{SimSun}}
...
\begin{document}
\title{latex {\SimSun 中文测试}}
\author{{\SimSun 张扬}(santa1987@gmail.com)}

\maketitle

{\SimSun 这里是一段中文。The English font here is ugly.}

$\sin{\sum_{i=0}^{n}\sinh{i}}$

{\Helvetica This part is in English, using the ``Helvetica'' font.}

{\SimSun 这里则是另外一段中文。下面的部分截取自算法作业1。}
